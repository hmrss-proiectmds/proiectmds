...
TODO: Fix Resignation Elo Bug. In `backend/app/services/game.py` (around line 467), when a player resigns, the `winner_seat` is missing from the terminal state dict. This breaks Elo calculations for forfeits.
